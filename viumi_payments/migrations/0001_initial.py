...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'Método de pago Viumi',
                'verbose_name_plural': 'Métodos de pago Viumi',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='viumi_payments', to='orders.order', verbose_name='compra')),
                ('payment_method', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='viumi_payments', to='viumi_payments.viumipaymentmethod', verbose_name='medio de pago')),
            ],
            options={
                'verbose_name': 'Pago Viumi',
                'verbose_name_plural': 'Pagos Viumi',
                'ordering': ('-created',),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='ipns', to='viumi_payments.viumipayment', verbose_name='Pago Viumi')),
            ],
            options={
                'verbose_name': 'IPN Viumi',
                'verbose_name_plural': 'IPNs Viumi',
                'ordering': ('-created',),
            },
        ),
    ]
